...
if __name__ == "__main__":
    ...
    titer = 4 # inner ADMM iters
    niter = 32 # outer ADMM iters
    ...
    with pt.SolverTomo(ntheta, nz, n, center) as slv:
        ...
        h = cp.zeros([3,nz, n, n], dtype='complex64')
        psi = cp.zeros([3,nz, n, n], dtype='complex64')
        lamd = cp.zeros([3,nz, n, n], dtype='complex64')
        u = slv.admm(data, h, psi, lamd, u, theta, alpha, titer, niter, dbg=True)
        # save results
